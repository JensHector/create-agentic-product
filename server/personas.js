// Persona definitions — the source of truth for how each executive behaves.
// The client holds display metadata + opening questions; the server holds the
// full system-prompt "brain" so the persona instructions never reach the browser.
